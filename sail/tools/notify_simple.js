;(function () {
    ...
    (function (_super) {
         ...
         *     "<span style='color:#98ff66;'>{{userName}}</span>",
         *     "<span style='color:#dff8ff;'>赢得超能量，获得</span>",
         *     "<span style='color:#ffd632;'>{{msg}}</span>",
         *     "<span style='color:#dff8ff;'>分。</span>"
         *  ].join("")
         */
        ...
        _proto.init = function (config) {
            ...
            if(!config.tpl){
                console.error("需在配置项中指定tpl字段");
            }

            NotifyItem.setup(config.fontSize);
        }
        _proto.setText = function (data) {
